    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ URL::to('/') }}/admin/state/add">Edit State</a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center mb-4">Edit State</h4>
                        <form id="stateForm" action="{{ route('update-state') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <input type="hidden" value="{{ $stateData->id }}" name="id">
                                <div class="mb-3 col-6">
                                    <label for="stateName" class="form-label">State Name</label>
                                    <input type="text" name="stateName" id="stateName" class="form-control"
                                        placeholder="Enter state name" value="{{ $stateData->state }}">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" name="stateCode" id="stateCode" class="form-control"
                                        placeholder="Enter state code" value="{{ $stateData->codeState }}">
