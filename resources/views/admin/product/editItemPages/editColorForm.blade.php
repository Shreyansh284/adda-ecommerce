            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="colorForm" action="{{ route('update-color') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" name="colorName" id="colorName" class="form-control"
                                        placeholder="Enter color name" value="{{ $color->color }}">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="color" name="colorCode" id="colorCode"
                                        class="form-control form-control-color" value="{{ $color->hexcode }}">
