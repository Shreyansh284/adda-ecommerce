            ...
            <div class="row">
                                ...
                                @foreach($cartItems as $item)
                                    ...
                                    <tr>
                                        <td>
                                            <div class="table-p__box">
                                                <div class="table-p__img-wrap">
                                                    <img class="u-img-fluid" src="{{ asset($item->product->images->first() ) }}" alt="">
                                                </div>
                                                <div class="table-p__info">
                                                    <span class="table-p__name">
                                                        <a href="{{ route('product.detail', $item->product->id) }}">{{ $item->product->productName }}</a>
                                                    </span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="table-p__price">${{ number_format($item->product->price, 2) }}</span>
                                        </td>
                                        <td>
                                            <div class="table-p__input-counter-wrap">
                                                <div class="input-counter">
                                                ...
                                                <span class="input-counter__minus fas fa-minus"></span>
                                                    <input class="input-counter__text" type="number" value="{{ $item->quantity }}" min="1" data-id="{{ $item->id }}">
                ...
                <div class="col-lg-4 col-md-6 u-s-m-b-30">
                    <div class="f-cart__pad-box">
                        ...
                        <a href="{{ route('checkout') }}" class="btn btn--e-brand-b-2">PROCEED TO CHECKOUT</a>
                    </div>
                </div>
            </div>
        </div>
