                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                ...
                                <a href="productDetails" class="primary-btn">Shop now <span class="arrow_right"></span></a>
    ...
    <section class="product spad">
        <div class="container">
            ...
            <div class="row product__filter">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="user/img/product/product-5.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="user/img/icon/heart.png" alt=""></a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-1">
                    <div class="categories__deal__countdown">
                        ...
                        <a href="productDetails" class="primary-btn">Shop now</a>
                    </div>
                </div>
            </div>
        </div>
