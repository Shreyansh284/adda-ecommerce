                ...
                <div class="col-lg-12 col-md-12 col-sm-12 u-s-m-b-30">
                    <div class="col-lg-4 col-md-6 u-s-m-b-30">
                        <div class="f-cart__pad-box">
                            ...
                            <div>
                                <a href="{{route('checkout')}}" class="btn btn--e-brand-b-2 " type="submit"> PROCEED TO CHECKOUT</a></div>
...
@section('content')
                            ...
                            <table class="table-p">
                                <tbody>
                                    ...
                                    @foreach ($cartItems as $item)
                                        ...
                                        <tr>
                                            <td>
                                                <div class="table-p__box" style="justify-content: space-around">
                                                    <div class="table-p__img-wrap">
                                                        <img {{-- class="u-img-fluid" --}} style="width: 100px;height: 100%"
                                                    ...
                                                    <div class="table-p__info">
                                                        <span class="table-p__name">
                                                            <a
                                                                href="{{ route('product.detail', $item->product->id) }}">{{ $item->product->productName }}</a>
                                                        </span>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="table-p__input-counter-wrap">
                                                    {{-- <div class="input-counter" style="display: flex">
                                                        <span class="input-counter__minus fas fa-minus"></span>
                                                        <input class="input-counter__text" type="number"
                                                    ...
                                                    <div class="input-counter">
                                                        <span class="input-counter__minus fas fa-minus"></span>
                                                        <input type="number" class="input-counter__text" value="1"
                                                            min="1">
                                                        <span class="input-counter__plus fas fa-plus"></span>
                                                    </div>
                                            ...
                                            <td>
                                                <div class="table-p__del-wrap">
                                                    <a class="far fa-trash-alt table-p__delete-link"
                                                        href="{{ route('cart.remove', parameters: $item->id) }}"></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <div class="f-cart__pad-box">
                            ...
                            <div style="padding-top: 1rem">
                                <a href="{{ route('checkout') }}" class="btn btn--e-brand-b-2"
                                    style="padding: 10px;">PROCEED TO CHECKOUT</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            // $(".input-counter__minus, .input-counter__plus").click(function() {
            //     var inputField = $(this).siblings(".input-counter__text");
            //     var currentQuantity = parseInt(inputField.val());
            //     var productId = inputField.data("id");
            //     var action = $(this).hasClass("input-counter__plus") ? "increase" : "decrease";
            ...
            //     // Call AJAX to update quantity in the database
            //     updateCartQuantity(productId, currentQuantity);
            // });
            document.querySelectorAll(".input-counter").forEach(function(counter) {
                let minusBtn = counter.querySelector(".input-counter__minus");
                let plusBtn = counter.querySelector(".input-counter__plus");
                let inputField = counter.querySelector(".input-counter__text");
            ...
            function updateCartQuantity(productId, quantity) {
                $.ajax({
                    url: "{{ route('cart.update') }}", // Define this route in web.php
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: productId,
